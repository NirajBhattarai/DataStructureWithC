...
1. **Push**: Adds an element to the collection. In a stack, the element is always added to the top.
2. **Pop**: Removes an element from the collection. In a stack, the topmost element is always the one removed.

## Additional Operations

1. **Peek / Top**: Gets the top data element of the stack, without removing it.
2. **IsEmpty**: Checks whether the stack is empty.
3. **IsFull**: Checks whether the stack is full.

## Applications

Stacks are useful in many situations where you want to reverse a sequence of items or where you want to store items in a specific order. They are used in many areas of programming, such as managing function calls (call stack), parsing (syntax stack), and expression evaluation.

See [application/](application/Readme.md) for the infix-to-postfix conversion algorithm and worked trace tables, and [practice-questions/](practice-questions/Readme.md) for additional practice problems.
